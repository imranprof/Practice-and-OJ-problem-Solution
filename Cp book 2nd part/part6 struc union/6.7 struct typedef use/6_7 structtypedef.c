...
//this function is for calculate grade
...
int main()
{
    ...
    for (i = 0; i < n; i++) {       //this loop is for input student id and name
    ...
    for (i = 0; i < n; i++) {       // this loop is for student grade
        calculate_grade(student[i], marks[i]);
    }

    printf("Output: \n\n");

    for (i = 0; i < n; i++) {               //this loop is for output student id , name and grade
        printf("ID: %d\n", student[i].id);
